  ...
  return (
    ...
    <div >
        <section className="sign-in">
            ...
            <select name="type" className="user"  value={type.type} onChange = {(e) => setType(e.target.value)}>
                <option value="Admin" selected>Admin</option>
                <option value="Student">Student</option>
                </select>  
            </div>  
                                <label for="your_name"></label>
                                          <input type="text" name="email" id="your_name" value={email} onChange = {(e) => setEmail(e.target.value)} placeholder="Your Email"/>
                            </div>
                            <div className="form-group">
                                <label for="your_pass"></label>
                                <input type="password" name="password"  value={password} onChange={(e) => setPassword(e.target.value)} id="your_pass" placeholder="Password"/>
                            </div>
                            <div className="form-group">
